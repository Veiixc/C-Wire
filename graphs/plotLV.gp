...
plot datafileEntry using (column(1)-0.4):2:xtic(1) title "Capacité" lc rgb "blue" with boxes, \
     datafileEntry using (column(1)-0.1):3 title "Consommation" lc rgb "purple" with boxes, \
     datafileEntry using (column(1)+0.2):4:(colorFunc($5)) title "Consommation absolue" lc rgb var with boxes
